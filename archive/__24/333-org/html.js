...
<head>
    ...
    <body >
        <script>
            ...
            //made by g (cancelled.work/pi)

            //this animation uses the simplex noise algorithm from a FOSS library
            ...
            let canvas = document.createElement('canvas'),
                ...
                disMult = .01,
                targetDisMult = .01,
                sizeMult = height > width ? height/15 : width/15,
                targetSzMult = 10,
                clearScreen = false,
            ...
            function createImg(s) {
                ...
                xUL = (width/sizeMult) -2
                yUL = (height/sizeMult) -2
                ...
                points = [];
                    ...
                    for (let x = limits.sX; x < limits.eX; x++) {
                        ...
                        for (let y = limits.sY; y < limits.eY; y++) {
                            ...
                            noiseX = (x/sizeMult + seed ) + s/1000 + (distance/(113377*disMult)),
                            noiseY = (y/sizeMult + seed ) + s/100 + (distance/113377*disMult),
                            N1 = simNoise.noise(noiseX*2, noiseY),
            ...
            function renderMouse() {
                const hue = ((frames/3) + Math.random() * 12 )%360
                // console.log(hue);
                context.fillStyle = `hsl(${hue}, 100%, 50%)`;
                context.beginPath()
                context.arc(mosPos.x, mosPos.y, 2 + Math.random(), 0, pi*2)
                context.fill()
            }
            ...
            function renderPoints(arr) {
                ...
                for (let i = 0; i < arr.length; i++) {
                    ...
                    for (let j = 0; j < arr[i].length; j++) {
                        ...
                        const colorVar = (p.dis/7)*p.r+144
                        const lightness = (((colorVar/5%80)+lightOff) * (1 + colorVar/100)) % 100

                        // const pColor = `hsl(${colorVar}, 100%, 77%)`;
                        const pColor = `hsl(${colorVar}, ${inColor ? 100 : 0}%, ${lightness}%)`;
            ...
            // const x = 10.5;
            // const y = 20.3;
            // const value = simplexNoise.noise(x, y);

            // // Print the result
            // console.log(`Simplex Noise value at (${x}, ${y}): ${value}`);
