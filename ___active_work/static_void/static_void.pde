...
int H = 1024;//(8K) 4320// (4K) 2160//(UHD) 1440//(HD) 1080//(M0S) 1050//(Square HD) 1024//(SD) 720 //1600
...
int noiseVar2 = 100;
int noiseVar3 = 1;
// int noiseVar1 = 1058;//500;
// int noiseVar2 = 4986;//100;
// int noiseVar3 = 9675;//1;
...
void initalize () {
  ...
  // angx = 180;//random(90)-30; // degrees
  // angz = 355;//random(90)-30; // degrees
  ...
  p = new PVector(0, 0, 0);
  // rz = new PVector(-1.0, -8.742278E-8, 0);
  // rx = new PVector(0.0, -0.08715603, 0.99619466);
  // p = new PVector(0, 0, 0);
}
...
void keyPressed() {
    switch(key) {
      ...
      case '1': 
        imgChoice--;
        if (imgChoice < 0 || imgChoice > IMG_MAX) {
          imgChoice = IMG_MAX;
        }
        break;
      case 'r':
