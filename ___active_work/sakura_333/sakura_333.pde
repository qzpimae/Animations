...
final int HEIGHT = 1024;//(300dpi) 7016// (8K) 4320// (print) 2472// (4K) 2160//(UHD)//(72dpi) 1648// 1440//(HD) 1080//(M0S) 1050//(Square HD) 1024//(SD) 720 //1600 //540
...
void draw() {
  ...
  if (zoomIn == 1) radius -= moveSpeed/50;
  else if (zoomIn == -1) radius += moveSpeed/50;
...
void keyPressed() {
  switch (key) {
    ...
    case '\b':
      ...
      break;
    case 'l':
      moveSpeed = moveSpeed < 200 ? moveSpeed+.1 : 200;
      break;
    case 'k':
      moveSpeed = moveSpeed > .1 ? moveSpeed-.1: .1;
      break;
    case 'm':
      moveSpeed = moveSpeed < 200 ? moveSpeed+.5 : 200;
      break;
    case 'n':
